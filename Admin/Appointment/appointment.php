...
<body>
    ...
    <div class="container">
        <aside id="mySidebar">
            <div class="sidebar">
                <p>
                    <span style="float:right;cursor:pointer;color: white;" id="cancel_btn"
                        class="material-symbols-sharp" onclick="closeNav()">
                        disabled_by_default
                    </span>
                </p><br>

                <ul>
                    <li style="height: 26px;"><a href="./../Dashboard/dashboard.php"><i
                                class="fa-solid fa-house"></i><span>&nbsp;&nbsp;Dashboard</span></li>
                    <li><a href="#" onclick="openBar1()"><i
                                class="fa-solid fa-user-doctor"></i><span>&nbsp;&nbsp;&nbsp;Doctor</span></a>
                        <i id="downword1" style="float:right;position:relative;right:10px;"
                            class="fa-solid fa-caret-down" onclick="openBar1()"></i>
                        <ul class="down_list" id="down1">
                            <li><a href="./../Doctor/add_doctor.php"><span>Add Doctor</span></a></li>
                            <li><a href="./../Doctor/Manage doctor/manage_doctor.php"><span>Manage Doctor</span></a><i
                                    id="upword" style="float:right;position:relative;left:32px;"
                                    class="fa-solid fa-caret-down" onclick="closeBar1()"></i></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="openBar2()"><i
                                class="fa-regular fa-user"></i><span>&nbsp;&nbsp;&nbsp;Employee</span></a>
                        <i id="downword2" style="float:right;position:relative;right:10px;"
                            class="fa-solid fa-caret-down" onclick="openBar2()"></i>
                        <ul class="down_list" id="down2">
                            <li><a href="./../Employee/add_employees.php"><span>Add Employee</span></a></li>
                            <li><a href="./../Employee/Manage employees/manage_employees.php"><span>Manage
                                        Employee</span></a><i id="upword"
                                    style="float:right;position:relative;left:32px;" class="fa-solid fa-caret-down"
                                    onclick="closeBar2()"></i></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="openBar3()"><i
                                class="fa-solid fa-bed-pulse"></i><span>&nbsp;&nbsp;Patient</span></a>
                        <i id="downword3" style="float:right;position:relative;right:10px;"
                            class="fa-solid fa-caret-down" onclick="openBar3()"></i>
                        <ul class="down_list" id="down3">
                            ...
                            <li><a href="./../Patients/manage patient/manage_patients.php"><span>Patient
                                        Analysis</span></a><i id="upword"
                                    style="float:right;position:relative;left:32px;" class="fa-solid fa-caret-down"
                                    onclick="closeBar3()"></i></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="openBar4()"><i
                                class="fa-regular fa-calendar-check"></i><span>&nbsp;&nbsp;&nbsp;Appointment</span></a>
                        <i id="downword4" style="float:right;position:relative;right:10px;"
                            class="fa-solid fa-caret-down" onclick="openBar4()"></i>
                        <ul class="down_list" id="down4">
                            ...
                            <li><a href="./edit appointment/manage_appointment.php"><span>Manage
                                        Appointments</span></a><i id="upword"
                                    style="float:right;position:relative;left:32px;bottom:16px;"
                                    class="fa-solid fa-caret-down" onclick="closeBar4()"></i></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="openBar5()"><i
                                class="fa-solid fa-briefcase"></i><span>&nbsp;&nbsp;&nbsp;Inventory</span></a>
                        <span><i id="downword5" style="float:right;position:relative;right:10px;"
                                class="fa-solid fa-caret-down" onclick="openBar5()"></i></span>
                        <ul class="down_list" id="down5">
                            <li><a href="">Update Inventory</a></li>
                            <li><a href="">Manage Inventory</a><i id="upword"
                                    style="float:right;position:relative;left:32px;" class="fa-solid fa-caret-down"
                                    onclick="closeBar5()"></i></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="openBar6()"><i
                                class="fa-solid fa-wallet"></i><span>&nbsp;&nbsp;&nbsp;Payment</span></a>
                        <i id="downword6" style="float:right;position:relative;right:10px;"
                            class="fa-solid fa-caret-down" onclick="openBar6()"></i>
                        <ul class="down_list" id="down6">
                            <li><a href=""><span>Patient Payment</span></a></li>
                            <li><a href=""><span>Employee Salary</span></a></li>
                            <li><a href=""><span>Doctor Salary</span></a><i id="upword"
                                    style="float:right;position:relative;left:32px;" class="fa-solid fa-caret-down"
                                    onclick="closeBar6()"></i></li>
                        </ul>
                    </li>
                    <li><a href="./../../LOGIN/HMS_home.php"><i
                ...
                <div class="title-and-search">
                    ...
                    <form action="" method="post">
                        <span class="search-patient">
                            ...
                            <button type="submit" name="search"><i name="search"
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    while ($row = mysqli_fetch_assoc($runQuery)) {
                        ...
                        <div class="patient-info" id="patient-info"><br>
                            <table class="patient-info-table" id="patient-info-table" border="0px">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="310px">
                                            <div class="input">
                                                <input type="text" name="patient-id" id="patient-id"
                                                    value="<?php echo $row['opd_id']; ?>" disabled>
                                            </div>
                                        </td>
                                        ...
                                        <td width="400px">
                                            <div class="input">
                                                <input type="text" name="patient-name" id="patient-name"
                                                    value="<?php echo $row['o_fname'] . " " . $row['o_lname']; ?>" disabled>
                                            </div>
                                        </td>
                                        ...
                                        <td width="">
                                            <div class="input">
                                                <input type="number" name="patient-age" id="patient-age"
                                                    value="<?php echo $row['o_age']; ?>" disabled>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input">
                                                <input type="text" name="patient-mobile" id="patient-mobile"
                                                    value="<?php echo $row['o_phone']; ?>" disabled>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="input">
                                                ...
                                                <input type="email" name="patient-email" id="patient-email"
                                                    value="<?php echo $row['o_email']; ?>" disabled>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="input">
                                                <input style="width:130px;" type="date" name="" id="lastvisit-date"
                                                    value="<?php echo $row['o_dob']; ?>" disabled>
                            ...
                            <div id="add-btn">
                                <a onclick="open_appointment()" id="new-appointment-btn"><i class="fa-solid fa-plus"></i> New
                                    Appointment</a>
                            </div>
                            <br>
                        </div><br><br>
                            ...
                            <table class="appointment-details" id="appointment-details" border="0px">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a onclick="open_editAppointment()"><i id="edit"
                        ...
                        <div class="new-appointment" id="new-appointment">
                            <form action="./book_appointment.php" class="appointment-form" id="appointment-form" method="POST">
                                <div class="heading1">
                                    <input type="text" placeholder=" " id="patient_name" name="p_name"
                                        value="<?php echo $row['o_fname'] . " " . $row['o_lname']; ?>">
                                ...
                                <div class="row1">
                                    <div class="input">
                                        ...
                                        <select name="department" id="department">
                                            ...
                                            <option value="GENERAL AND LAPROSCOPIC SURGERY">GENERAL AND LAPROSCOPIC SURGERY
                                            </option>
                                ...
                                <form action="./edit_appointment.php" class="appointment-form" id="appointment-form" method="POST">
                                    ...
                                    <div class="row1">
                                        <div class="input">
                                            <label for="department">Department :</label>
                                            <select name="department" id="department">
                                                <option value="<?php echo $row1['department']; ?>"><?php echo $row1['department']; ?>
                                                </option>
                                                <option value="GENERAL PHYSICIAN & MEDICINE">GENERAL PHYSICIAN & MEDICINE</option>
                                                <option value="DIABETOLO & ENDOCRINOLOGY">DIABETOLO & ENDOCRINOLOGY</option>
                                                <option value="INTERVENTIONAL CARDIOLOGY">INTERVENTIONAL CARDIOLOGY</option>
                                        ...
                                        <div class="input">
                                            <label for="doctor">Doctor :</label>
                                            <select name="doctor" id="doctor">
                                                <option value="<?php echo $row1['doctor']; ?>"><?php echo $row1['doctor']; ?>
                                                </option>
                                                <option value="Akhilesh Tomar">Dr Akhilesh Tomar</option>
                                                <option value=" Neha Sharma">Dr Neha Sharma</option>
                                                <option value="Rajat Pawar">Dr Rajat Pawar</option>
                                        ...
                                        <div class="input">
                                            <label for="patient_fees">Fees :</label>
                                            <input type="text" name="fees" placeholder=" " value="<?php echo $row1['fees']; ?>"
                                                id="patient_fees">
                                        </div>
                                        <div class="input">
                                            <label for="patient_appointment_date">Appointment Date</label>
                                            <input type="date" name="date" placeholder=" " value="<?php echo $row1['app_date']; ?>"
                                    ...
                                    <div class="row2">
                                        <div class="input">
                                            <label for="slots">Slot :</label>
                                            <select name="slots" id="slots">
                                                <option value="<?php echo $row1['slot']; ?>" id="8-9"><?php echo $row1['slot']; ?>
                                                </option>
                                        ...
                                        <div class="input">
                                            <label for="payment_date">Payment Mode</label>
                                            <select name="payment_type" id="payment_mode">
                                                <option value="<?php echo $row1['payment_method']; ?>">
                                                    <?php echo $row1['payment_method']; ?></option>
                                                <option value="Cash">Cash</option>
                                                <option value="Credit-card">Credit Card</option>
                                                <option value="Debit-card">Debit Card</option>
                                                <option value="UPI">UPI</option>
                                    ...
                                    <div class="row3">
                                        <div class="input">
                                            <label for="note">Message</label>
                                            <textarea name="note" id="note" cols="77" rows="3"
                                                value=""><?php echo $row1['add_message']; ?></textarea>
                                        </div>
                                        <div class="input">
                                            <label for="live-consultation">Live Consultation :</label>
                                            <select name="live" id="live-consultation">
                                                <option value="<?php echo $row1['live_consultation']; ?>">
                                                    <?php echo $row1['live_consultation']; ?></option>
                                                <option value="No">No</option>
                                                <option value="Yes">Yes</option>
                                            </select>
                        ...
                        <table class="patient-info-table" id="patient-info-table" border="0px">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input">
                                            <input style="width:130px;" type="date" name="" id="lastvisit-date" value=""
                                                disabled>
