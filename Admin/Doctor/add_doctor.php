    ...
    <div class="container">
                    ...
                    <ul>
                        ...
                        <li><a href="#" onclick="openBar1()"><i class="fa-solid fa-user-doctor"></i><span>&nbsp;&nbsp;&nbsp;Doctor</span></a>
                            ...
                            <ul class="down_list" id="down1">
                                ...
                                <li><a href="./Manage doctor/manage_doctor.php"><span>Manage Doctor</span></a><i id="upword" style="float:right;position:relative;left:32px;" class="fa-solid fa-caret-down" onclick="closeBar1()" ></i></li>
                            </ul>
                        </li>
        ...
        <div class="right">
            <div class="register_form">
                <form action="http://localhost/hms/Admin/add_doctor2.php" method="post">
                    <div class="containt1">
                        <h1 style="text-align: center;">Doctor Registration </h1><br>
                    <fieldset>
                        ...
                        <table id="p_info" style="width:100%;padding-left:1.5rem;" border="0px">
                            <tr>
                                ...
                                <td style="width: 18%;"><input type="text" id="fname" name="fname" placeholder="surname"></td>
                                <td style="width: 8%;"><label for="mname">Middle Name<span> * </span>  : </label></td>
                                <td style="width: 18%;"><input type="text" id="mname" name="mname" placeholder=""></td>
                                <td style="width: 8%;"><label for="lname">Last Name<span> * </span>  : </label></td>
                                <td style="width: 20%;"><input type="text" id="lname" name="lname"></td>
                            </tr>
                            <!-- <tr>
                                <td><label for="father_name">Father Name <span> * </span>:</label></td>
                                <td><input type="text" name="" id="father_name"></td>
                                <td><label for="mother_name">Mother Name <span> * </span>:</label></td>
                                <td><input type="text" name="" id="mother_name"></td>
                            </tr> -->
                            <tr><td></td></tr>
                            <tr>
                                ...
                                <td>
                                    <select id="marital_status" name="married">
                                        <option value="Select" disabled>--select--</option>
                            ...
                            <tr>
                                ...
                                <td><input type="tel" id="contact_no" name="phone"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="file" name="" id="identity"></td>
                            </tr>
                        </table><br><br>
                        ...
                        <table border="0px" style="width:100%;padding-left:1.5rem;">
                            <tr>
                                ...
                                <td style="width: 22%;"><input type="text" name="society_name" id="building_name" placeholder=""></td>
                                <td style="width: 10%;"><label for="area">Area<span> * </span>  : </label></td>
                                <td style="width: 22%;"><input type="text" name="area" id="street_name"></td>
                            </tr>
                            <tr><td></td></tr>
                            <tr>
                    ...
                    <br><br>
                        ...
                        <table border="0px" style="width:100%;padding-left:1.4rem;">
                            <tr>
                                <td style="width: 12%;"><label for="specialization">Specialization<span> *</span> :</label></td>
                                <td style="width: 20%;">
                                    <select name="special" id="specialization">
                                ...
                                <td style="width: 14%;"><label for="degree">Degree :</label></td>
                                <td style="width: 16%;"><input type="text" name="degree" id="document_no"></td>
                                <td style="width: 12%;"><label for="degree_certificate">Degree Certificate <span>*</span> : </label></td>
                                <td style="width: 16%;"><input type="file" name="degree" id="degree_certificate"><p style="font-size: 10px; color: red;">(Jpeg and pdf files only)</p></td>
                            </tr><td></td>
                            <tr></tr>
                            <tr>
                                <td><label for="institute_name">Institute Name<span> * </span>:</label></td>
                                <td><textarea name="institute" id="institute_name" cols="25" rows="2"></textarea></td>
                                <td><label for="institute_address">Address :</label></td>
                                <td><textarea id="institute_address" name="institute_address" cols="25" rows="3"></textarea></td>
                                <td><label for="lname">Appointment Availability <span> * </span>: </label></td>
                                <td><input type="time" id="lname" name="timing"> to <input type="time" name="2timing" id="lname"></td>
                            </tr>
                            <tr><td></td></tr>
                            <tr>
                                ...
                                <td><input type="text" name="day_offs" id="day_offs"></td>
                            </tr>
                        </table>
                        <br><br>
                        ...
                        <table border="0px" style="width:100%;padding-left:1.4rem;">
                            <tr>
                                ...
                                <td style="width: 22%;"><input type="text" name="acc_name" id="name_inbank" placeholder="Name as per bank account"></td>
                                <td style="width: 11%;"><label for="bank_name">Bank Name <span> * </span>: </label></td>
                                <td style="width: 22%;"><input type="text" name="bank" id="bank_name" placeholder=""></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="ifsc" id="ifsc_code"></td>
                            </tr>
                        </table>
                        <br><br>
                        <div class="conditions">
                            <input type="checkbox" height="20px" name="" id="conditions">
                            <label for="conditions">I agree with Terme & Conditions <span>*</span></label>
                        </div>
                        <br><br>
                        <div class="buttons">
